  ...
  return (
    <nav className="flex items-center py-4 px-39 justify-between shadow-md h-20 fixed w-full z-999 bg-white">
      <div className="flex items-center gap-2">
        <div className="flex justify-items-start items-center gap-2 w-38 py-4 ">
          <NavLink
            to="./"
        ...
        <div className="flex gap-1 text-[#6B788E] font-medium">
      ...
      <div className="flex justify-end items-center gap-8 h-12 flex-1">
        ...
        <div className="flex justify-center items-center gap-2">
          <NavLink
            to="./contact"
            className="bg-[#D95103] py-3 px-5.5 text-white font-[14px] rounded-[100px] h-10.25 flex items-center justify-center"
          >
            Contact Us
          </NavLink>
          <div>
